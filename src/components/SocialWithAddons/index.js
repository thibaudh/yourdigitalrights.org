...
const Social = (props) => {
  ...
  return (
  <div className={classNames(classes.root, className, 'ss')} style={props.style}>
...
SocialWithAddons.propTypes = {
  intl: intlShape.isRequired
};

export default withStyles(styles)(injectIntl(SocialWithAddons));
